  ...
  return (
    <div className="mx-auto max-w-7xl space-y-10 px-5 py-10 md:px-8 lg:py-16">
      ...
      <div className="grid gap-4 md:grid-cols-4">
        ...
        <div className="panel-soft p-5"><p className="text-sm text-slate-400">Assigned rides</p><p className="mt-2 text-3xl font-semibold text-white">{schedules.filter((schedule) => schedule.status === 'assigned').length}</p></div>
